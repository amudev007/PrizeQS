package www.softdev.com.prizeqs.Classes;
...
public class FoodDatabase {
    ...
    private static final String KEY_ROWID="id"; private static final String KEY_FOODNAME="foodname";
    private static final String KEY_CARBOHYDRATES="carbohydrates"; private static final String
            KEY_PROTEINS="proteins"; private static final String KEY_SATURATEDFAT="saturatedfat"; private
    static final String KEY_TOTALFAT="totalfat"; private static final String
            KEY_CALORIES_FAT_FOOD="caloriesfatfood"; private static final String KEY_CATEGORY="category";
    private static final String KEY_CALORIES="calories"; private static final String
            DATABASE_NAME="FoodDatabase_updated"; private static final int DATABASE_VERSION=1; private
    static final String DATABASE_TABLE="FoodDatabaseTable_updated";
